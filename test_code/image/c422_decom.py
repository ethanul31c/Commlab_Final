...
def c422_decom(img_ycbcr_com, filename):
  Hp = np.linalg.inv(H)
  ...
  plt.imsave(os.path.join(os.path.dirname(__file__), f"../../test_image/{filename}_422_decom.bmp"), img_ycbcr_com_rgb_decom)
  return  

if __name__ == "__main__":
  data = np.load("./../../buffer/Peppers_com.npy")
  # data = np.load("./../../buffer/Peppers_com.npy")
  c422_decom(data, "Peppers")